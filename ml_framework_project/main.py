...
def diamonds_regression_entrypoint() -> None:
    parser = argparse.ArgumentParser(description="Run the diamonds regression preprocessing pipeline")
...
def diamonds_classification_entrypoint() -> None:
    parser = argparse.ArgumentParser(description="Run the diamonds classification preprocessing pipeline")
    parser.add_argument("file_path", help="Path to input dataset (e.g., CSV)")
    args = parser.parse_args()
